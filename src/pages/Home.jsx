        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-16">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center bg-white p-1 rounded-lg border border-slate-200 shadow-sm"
                     data-id="element-164">
                    <button
                        className="relative flex items-center space-x-2 px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 text-slate-900"
                        data-id="element-165">
                        <div className="absolute inset-0 bg-slate-100 rounded-md shadow-sm border border-slate-200/50"
                             data-id="element-166" style={{opacity: 1}}></div>
                        <span className="relative z-10 flex items-center space-x-2" data-id="element-167"><svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                            className="lucide lucide-flame w-4 h-4 text-blue-500" aria-hidden="true"
                            data-id="element-168"><path
                            d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"></path></svg><span
                            data-id="element-169">Hot</span>
                        </span>
                    </button>
