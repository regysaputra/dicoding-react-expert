...
function HomePage() {
  ...
  const filteredThreads =
    selectedValue === "all"
      ? threadList
      : threadList.filter(
          (thread) => thread.category.toLowerCase() === selectedValue,
        );
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-16">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div
          className="flex items-center bg-white p-1 rounded-lg border border-slate-200 shadow-sm"
          data-id="element-164"
        >
          <button
          ...
          >
            <div
              className="absolute inset-0 bg-slate-100 rounded-md shadow-sm border border-slate-200/50"
              data-id="element-166"
              style={{ opacity: 1 }}
            ></div>
            <span
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-flame w-4 h-4 text-blue-500"
                aria-hidden="true"
                data-id="element-168"
              >
          ...
          <button
            className="relative flex items-center space-x-2 px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 text-slate-500 hover:text-slate-700 hover:bg-slate-50"
            data-id="element-165"
          >
            <span
              className="relative z-10 flex items-center space-x-2"
