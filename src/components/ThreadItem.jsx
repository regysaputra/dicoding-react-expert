...
const threadItemPropsSchema = Joi.object({
  thread: Joi.object({
    ...
    upVotesBy: Joi.array().items(
      Joi.object({
        id: Joi.number().required(),
      }),
    ),
    downVotesBy: Joi.array().items(
      Joi.object({
        id: Joi.number().required(),
      }),
    ),
            ...
            <div className="flex-1 p-5" data-id="element-99">
              ...
              >
                ...
                <div className="flex space-x-2" data-id="element-107">
                  <span
                    className="px-2 py-0.5 bg-slate-100 text-slate-600 text-[10px] uppercase font-bold tracking-wider rounded-full"
                    data-id="element-108"
                  >
                    {thread?.category}
                  </span>
              ...
              <div
                className="flex items-center justify-between pt-2 border-t border-slate-50 mt-2"
                data-id="element-112"
              >
                <div
                ...
                >
                  ...
                  <div
                    className="flex items-center space-x-1.5 text-slate-500 hover:text-blue-600 transition-colors text-sm group/comments"
                    data-id="element-114"
                    href="/thread/1"
                  >
                    <svg
