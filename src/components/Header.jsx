...
function Header(props) {
  const { authUser, onLogout } = validateProps(
    headerPropsSchema,
    props,
    "Header",
  );
  ...
  function ActionComponent() {
    if (authUser) {
      return (
        <div className="relative" ref={menuRef}>
          ...
          {open && (
            <div
              className="absolute right-0 mt-2 w-56 origin-top-right rounded-xl bg-white shadow-lg ring-1 ring-black/5 focus:outline-none overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200"
              data-id="element-52"
            >
              <div
              ...
              <div className="py-1" data-id="element-56">
                ...
                >
                  <svg
                    ...
                    className="lucide lucide-user h-4 w-4 text-gray-400"
                    aria-hidden="true"
                    data-id="element-58"
                  >
    ...
    return (
      <button
        ...
        type="button"
        className="bg-indigo-600 hover:bg-indigo-700 text-white box-border border border-transparent rounded-lg focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
      >
        Login
      </button>
    );
  ...
  return (
    <header
      className="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 z-10"
      data-id="element-119"
    >
      <div
      ...
      >
        ...
        >
          <div
            className="w-8 h-8 bg-slate-900 rounded-lg flex items-center justify-center text-white group-hover:bg-blue-600 transition-colors"
            data-id="element-122"
          >
            <span className="font-bold text-lg" data-id="element-123">
              D
            </span>
          </div>
          <span
        ...
        >
          <Link
            to="/"
            className="relative px-4 py-2 rounded-md flex items-center space-x-2 text-sm font-medium transition-colors text-slate-500 hover:text-slate-900 hover:bg-slate-50"
            data-id="element-126"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
