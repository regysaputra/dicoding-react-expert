    ...
    switch (action.type) {
            ...
            return  {
                ...
                comments: threadDetail.comments.map((comment) => {
                    if (comment.id === action.payload.commentId) {
                        const newUpVotesBy = comment.upVotesBy.concat(action.payload.userId);

                        const newDownVotesBy = comment.downVotesBy.filter((id) => id !== action.payload.userId);
        ...
        case ActionType.TOGGLE_DOWNVOTE_COMMENT:
            return  {
                ...
                comments: threadDetail.comments.map((comment) => {
                    if (comment.id === action.payload.commentId) {
                        const newUpVotesBy = comment.upVotesBy.filter((id) => id !== action.payload.userId);

                        const newDownVotesBy = comment.downVotesBy.concat(action.payload.userId);
        ...
        case ActionType.TOGGLE_NEUTRALIZEVOTE_COMMENT:
            return  {
                ...
                comments: threadDetail.comments.map((comment) => {
                    if (comment.id === action.payload.commentId) {
                        const newUpVotesBy = comment.upVotesBy.includes(action.payload.userId) ?
                            comment.upVotesBy.filter((id) => id !== action.payload.userId)
                            : comment.upVotesBy;

                        const newDownVotesBy = comment.downVotesBy.includes(action.payload.userId) ?
