...
describe("Thread detail action creators", () => {
  ...
  describe("sync action creator", () => {
    ...
    it("should create TOGGLE_NEUTRALIZEVOTE_THREAD action correctly", () => {
      const userId = "user-1";
      const expectedAction = {
        type: "TOGGLE_NEUTRALIZEVOTE_THREAD",
        payload: { userId },
      };
      expect(toggleNeutralizeVoteThreadActionCreator(userId)).toEqual(
        expectedAction,
      );
    });
    ...
    it("should create TOGGLE_DOWNVOTE_COMMENT action correctly", () => {
      ...
      expect(toggleDownVoteCommentActionCreator(userId)).toEqual(
        expectedAction,
      );
    });
    ...
    it("should create TOGGLE_NEUTRALIZEVOTE_COMMENT action correctly", () => {
      const userId = "user-1";
      const expectedAction = {
        type: "TOGGLE_NEUTRALIZEVOTE_COMMENT",
        payload: { userId },
      };
      expect(toggleNeutralizeVoteCommentActionCreator(userId)).toEqual(
        expectedAction,
      );
    });
  });
  ...
  describe("async thunk", () => {
    ...
    describe("asyncAddComment", () => {
      it("should dispatch action correctly when API call success", async () => {
        ...
        expect(dispatch).toHaveBeenCalledWith(
          addCommentActionCreator(fakeNewComment),
        );
      });
    ...
    describe("asyncToggleUpVoteThread", () => {
      it("should dispatch action correctly when API call success", async () => {
        ...
        expect(dispatch).toHaveBeenCalledWith(
          toggleUpVoteThreadActionCreator(fakeAuthUser.id),
        );
      });
      ...
      it("should rollback vote and alert error when API call fails", async () => {
        ...
        expect(global.alert).toHaveBeenCalledWith(fakeErrorResponse.message);
        expect(dispatch).toHaveBeenCalledWith(
          toggleNeutralizeVoteThreadActionCreator(fakeAuthUser.id),
        );
      });
    });
    ...
    describe("asyncToggleDownVoteThread", () => {
      it("should dispatch action correctly when API call success", async () => {
        ...
        expect(dispatch).toHaveBeenCalledWith(
          toggleDownVoteThreadActionCreator(fakeAuthUser.id),
        );
      });
    ...
    describe("asyncToggleNeutralizeVoteThread", () => {
      it("should dispatch action correctly when API call success", async () => {
        ...
        // Action
        await asyncToggleNeutralizeVoteThread("thread-1")(
          dispatch,
          fakeGetState,
        );
    ...
    describe("asyncToggleUpVoteComment", () => {
      it("should dispatch action correctly when API call success", async () => {
        ...
        // Action
        await asyncToggleUpVoteComment("thread-1", "comment-1")(
          dispatch,
          fakeGetState,
        );
        ...
        expect(dispatch).toHaveBeenCalledWith(
          toggleUpVoteCommentActionCreator(fakeAuthUser.id, "comment-1"),
        );
      });
    ...
    describe("asyncToggleDownVoteComment", () => {
      it("should dispatch action correctly when API call success", async () => {
        ...
        // Action
        await asyncToggleDownVoteComment("thread-1", "comment-1")(
          dispatch,
          fakeGetState,
        );
        ...
        expect(dispatch).toHaveBeenCalledWith(
          toggleDownVoteCommentActionCreator(fakeAuthUser.id, "comment-1"),
        );
      });
    ...
    describe("asyncToggleNeutralizeVoteComment", () => {
      it("should dispatch action correctly when API call success", async () => {
        ...
        // Action
        await asyncToggleNeutralizeVoteComment("thread-1", "comment-1")(
          dispatch,
          fakeGetState,
        );
