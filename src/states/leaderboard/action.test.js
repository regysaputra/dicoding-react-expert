import {asyncPopulateLeaderboard, receiveLeaderboardActionCreator} from "./action.js";
...
describe("leaderboard action", () => {
  describe("sync action creator", () => {
    it("should create RECEIVE_LEADERBOARD action correctly", () => {
      ...
      const expectedAction = { type: "RECEIVE_LEADERBOARD", payload: { leaderboard: leaderboards } };
  ...
  describe("async thunk", () => {
    describe("getLeaderboard", () => {
      it("should dispatch action correctly when API call success", async () => {
        ...
        expect(dispatch).toHaveBeenCalledWith(receiveLeaderboardActionCreator(leaderboards));
      });
